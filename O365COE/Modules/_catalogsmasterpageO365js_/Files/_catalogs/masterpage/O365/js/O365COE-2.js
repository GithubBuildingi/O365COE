...
function createQuery(queryTerms, mpPrefix) {
    //queryTerms -> ["1:Web Based Solutions", "0:Plan"]
...
function createXrankQuery(kqlQuery, queryTerms, mpPrefix, boostMultiplier) {
    ...
    //((owstaxIdCOEParentTopic:"Submit an App" owstaxIdCOEParentTopic:"Deploy") XRANK(cb=200) owstaxIdCOEParentTopic:"Submit an App") XRANK(cb=100) owstaxIdCOEParentTopic:"Deploy"    
    return kqlQuery;
}
