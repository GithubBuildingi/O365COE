...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	...
	<div class="article article-body">
		...
		<!-- Second Band (Image Left with Text) -->
 		<div class="row" id="it_rd_row_2">
			<div class="large-4 columns">
    			<WebPartPages:WebPartZone id="CenterZone1" runat="server" title="Zone 2"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
    		</div>
			<div class="large-8 columns">
				<WebPartPages:WebPartZone id="CenterZone2" runat="server" title="Zone 3"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
			</div>
		</div>
		...
		<div class="row" id="it_rd_row_3">
			<div class="large-8 columns">
				<WebPartPages:WebPartZone id="CenterZone3" runat="server" title="Zone 4"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
			</div>
			<div class="large-4 columns">
				<WebPartPages:WebPartZone id="CenterZone4" runat="server" title="Zone 5"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
			</div>
		</div>
		...
		<div class="row" id="it_rd_row_4">
			<div class="large-12 columns"> 
				<WebPartPages:WebPartZone id="Bottom" runat="server" title="Zone 6"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
			</div>
		</div>
	</div>
</asp:Content>
